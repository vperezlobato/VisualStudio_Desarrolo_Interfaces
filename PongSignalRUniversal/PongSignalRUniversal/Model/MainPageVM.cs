...
namespace PongSignalRUniversal.Model
{
    public class MainPageVM : clsVMBase
    {
        ...
        public MainPageVM(){
            ...
            _jugador1 = new objetoJuego(100, 100, "jugador1", "jugador1", false, 50, 100);
            _jugador2 = new objetoJuego(880, 100, "jugador2", "jugador2", false, 50, 0);
            _pelota = new objetoJuego(250, 500, "pelota", "pelota", false, 100,200);
        ...
        public void move()
        {
            Double posicionFutura = _jugador1.posicionX + _jugador1.velocidad;
            if (posicionFutura > 0 && posicionFutura < 1275)
            {
                _jugador1.posicionX += _jugador1.velocidad;
            }
            NotifyPropertyChanged("jugador1");
        }
        ...
        {
            //_velocidad = -10;
            if (_jugador1.posicionX > 0 && _jugador1.posicionX - 10 > 0)
            {
                _jugador1.velocidad = -10;
            }
            else
